...
## OUT OF SAMPLE ERROR
###  The out of sample error was estimated using cross validation (estimated error = 0.54%). Refer to compiled html link below (section 11 of code)
...
[Linked to Compiled HTML](http://htmlpreview.github.io/?https://github.com/adrom123/Practical-Machine-Learning/blob/master/pmlproject.html)
